...
COMMENT ON COLUMN uploaded_files.hash IS 'Хэш файла (SHA-256) для проверки дубликатов';
COMMENT ON COLUMN uploaded_files.status IS 'Статус обработки файла';
COMMENT ON COLUMN uploaded_files.total_rows IS 'Общее количество строк в файле';
COMMENT ON COLUMN uploaded_files.processed_rows IS 'Количество обработанных строк';
